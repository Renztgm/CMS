...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2025 at 07:57 AM
...
INSERT INTO `sections` (`id`, `name`, `type`, `parent_id`, `width`, `height`, `align_items`, `justify_content`, `padding`, `margin`, `background_color`, `border_value`, `border_style`, `border_color`, `border_radius`, `created_at`, `page_id`, `flex_direction`) VALUES
...
INSERT INTO `section_elements` (`id`, `section_id`, `element_type`, `content`, `width`, `height`, `alignment`, `padding`, `margin`, `border`, `border_radius`, `created_at`) VALUES
